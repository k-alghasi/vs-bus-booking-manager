...
## [1.9.2] - 2025-11-19
### Fixed
- رفع مشکل نمایش انتخابگر صندلی در صفحه محصول
- تغییر هوک نمایش از `woocommerce_before_add_to_cart_form` به `woocommerce_single_product_summary` برای سازگاری بهتر با تم‌ها
- رفع خطاهای نحوی و بهبود پایداری کد

### Added
- تنظیمات چیدمان پیشرفته صندلی‌ها (2-2-2, 2-3-2, 1-2, VIP, با راه پله)
- placeholder برای ویرایشگر بصری چیدمان سفارشی
- دیباگ پیشرفته با لاگ‌های خطا برای عیب‌یابی

### Improved
- بهبود سازگاری با تم‌های مختلف WooCommerce
- ساده‌سازی کدهای نمایش برای جلوگیری از تداخل
- بهینه‌سازی عملکرد انتخابگر صندلی
